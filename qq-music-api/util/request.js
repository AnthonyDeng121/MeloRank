...
const setHeaders = (headers, cookie) => {
  return {
    ...headers,
    cookie: cookie || global.userInfo.cookie
  };
};
...
function request(url, method = 'GET', options = {}, isUUrl = 'c', cookie = null) {
  let baseURL = '';
  switch (isUUrl) {
    case 'y':
      baseURL = yURL + url;
  ...
  options = Object.assign(options, {
    headers: setHeaders(options.headers || {}, cookie),
  });
